...
static QJsonArray serializeExpenses(const QList<Expense> &list)
{
    QJsonArray arr;
    for (const auto &item : list)
    {
...
QJsonObject UserData::toJson() const
{
    ...
    obj["expenses"] = serializeExpenses(expenses);
    return obj;
}
...
static void deserializeIncomes(const QJsonArray &arr, QList<IncomeStream> &list)
{
    ...
    {
        if (value.isObject())
            list.append(IncomeStream::fromJson(value.toObject()));
    }
}
...
static void deserializeBills(const QJsonArray &arr, QList<Bill> &list)
{
    ...
    {
        if (value.isObject())
            list.append(Bill::fromJson(value.toObject()));
    }
}
...
static void deserializeInvoices(const QJsonArray &arr, QList<Invoice> &list)
{
    ...
    {
        if (value.isObject())
            list.append(Invoice::fromJson(value.toObject()));
    }
}
...
static void deserializePlans(const QJsonArray &arr, QList<PlanItem> &list)
{
    ...
    {
        if (value.isObject())
            list.append(PlanItem::fromJson(value.toObject()));
    }
}

static void deserializeExpenses(const QJsonArray &arr, QList<Expense> &list)
{
    list.clear();
    for (const auto &value : arr)
    {
        if (value.isObject())
            list.append(Expense::fromJson(value.toObject()));
    }
}
...
UserData UserData::fromJson(const QJsonObject &obj)
{
    ...
    deserializeExpenses(obj.value("expenses").toArray(), data.expenses);
    return data;
}